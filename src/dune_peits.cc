...
// Zoltan is used for the user defined partitioning
#include "zoltan.h"
...
double algorithm ( HGridType &grid, Dune::Fem::DynamicVector< double > &sigmavector,
		Dune::Fem::DynamicVector< double > &elementIDvector, int step, ElectrodePositions &electrodes, CurrentProtocol &current_protocol )
{
  ...
  typedef Dune::Fem::DynamicVector<double> SigmaVectorType;
...
#warning using PETSC
  ...
  typedef Dune::tuple< const typename SchemeTypeOne::DiscreteFunctionType *, GridExactSolutionType * > IOTupleType;
...
///////////////////////////////////////////////////
	...
	typedef LeafAdaptation< HGridType > AdaptationType;
